        ...
        <section class="container-xxl ">
            <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                ...
                <section class="d-flex justify-content-between align-items-center d-md-block">
                    <a class="text-decoration-none" href="{{ route('site.home') }}"><img src="{{ asset('site-assets/images/logo/8.png') }}" alt="logo"></a>
                    ...
                    <form action="{{ route('site.products', request()->category ?? null) }}">
                        <section class="search-box">
                            <section class="search-textbox">
                                ...
                                <input id="search" name="search" type="text" class="" value="{{ request()->search }}" placeholder="جستجو ..." autocomplete="off">
                            </section>
                        </section>
                    </form>
                </section>
                ...
                <section class="mt-3 mt-md-auto text-end">
                    @auth
                        <section class="d-inline px-md-3">
                            ...
                            <section class="dropdown-menu dropdown-menu-end custom-drop-down" aria-labelledby="dropdownMenuButton1">
                                <section><a class="dropdown-item" href="{{ route('site.account.profile.index') }}"><i class="fa fa-user-circle"></i>پروفایل کاربری</a></section>
                                <section><a class="dropdown-item" href="{{ route('site.account.orders.index') }}"><i class="fa fa-newspaper"></i>سفارشات</a></section>
                                <section><a class="dropdown-item" href="{{ route('site.account.favorite.index') }}"><i class="fa fa-heart"></i>لیست علاقه مندی</a></section>
                                <section><hr class="dropdown-divider"></section>
                                <section><a class="dropdown-item" href="{{ route('site.auth.logout') }}"><i class="fa fa-sign-out-alt"></i>خروج</a></section>
                            </section>
                        </section>
                    @endauth
                    ...
                    @guest
                            <section class="d-inline px-md-3">
                                <a href="{{ route('site.auth.login-register') }}" class="text-decoration-none text-dark"><i class="fa fa-user me-2"></i>ورود/ثبت نام</a>
                            </section>
                    @endguest
                    ...
                    <section class="header-cart d-inline ps-3 border-start position-relative">
                        ...
                        <section class="header-cart-dropdown">
                            <section class="border-bottom d-flex justify-content-between p-2">
                                ...
                                <a class="text-decoration-none text-info" href="{{ route('site.sale.cart') }}">مشاهده سبد خرید </a>
                            </section>
                            ...
                            <section class="header-cart-dropdown-body">
                                @foreach($cartItems as $item)
                                    ...
                                    <section class="header-cart-dropdown-body-item d-flex justify-content-start align-items-center">
                                        <img class="flex-shrink-1" src="{{ asset($item->product->image['index_array']['small']) }}" alt="{{ $item->product->name }}">
                                        <section class="w-100 text-truncate">
                                            <a class="text-decoration-none text-dark" href="{{ route('site.product.single', $item->product->slug) }}">{{ $item->product->name }}</a>
                                        </section>
                                        <section class="flex-shrink-1">
                                            <a class="text-muted text-decoration-none p-1" href="{{ route('site.sale.remove-from-cart', $item->id) }}">
                            ...
                            <section class="header-cart-dropdown-footer border-top d-flex justify-content-between align-items-center p-2">
                                <section class="">
                                    ...
                                    <section> {{ priceFormat($totalCartPrice - $totalCartDiscountPrice) }} تومان</section>
                                </section>
                                <section class="">
                                    <a class="btn btn-danger btn-sm d-block" href="{{ route('site.sale.cart') }}">ثبت سفارش</a>
                                </section>
                            </section>
                        </section>
                    </section>
            ...
            <nav class="">
                ...
                <section class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="z-index: 9999999;">
                    <section class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasExampleLabel"><a class="text-decoration-none" href="index.html"><img src="{{ asset('site-assets/images/logo/8.png') }}" alt="logo"></a></h5>
