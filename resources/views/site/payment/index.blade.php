...
@section('title','انتخاب درگاه پرداخت - فروشگاه آمازون')
                        ...
                        <section class="row mt-4">
                            <section class="col-md-9">
                                <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                    ...
                                    <form action="{{ route('site.sale.payment.apply-coupon') }}" method="post">
                                        @csrf
                                        <section class="row">
                                ...
                                <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                    ...
                                    <section class="payment-select">
                                        ...
                                        <input type="radio" form="payment_submit_form" name="payment_id" value="1" id="d1"/>
                                        ...
                                        <input type="radio" form="payment_submit_form" name="payment_id" value="2" id="d2"/>
                                        ...
                                        <input type="radio" form="payment_submit_form" name="payment_id" value="3" id="d3"/>
                            ...
                            <section class="col-md-3">
                                <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                    ...
                                    <section class="">
                                        ...
                                        <button id="final-level" onclick="document.getElementById('payment_submit_form').submit();" type="button" class="btn btn-danger d-none">ثبت سفارش و گرفتن کد رهگیری</button>
                                    </section>

                                    <form action="{{ route('site.sale.payment.submit') }}" id="payment_submit_form" method="post">
                                        @csrf
                                    </form>
                                </section>
                            </section>
