...
@section('title', 'ادمین - ویرایش اولویت تیکت ها')

@section('content')
    @include('admin.layouts.breadcrumb',['title'=>'ویرایش اولویت تیکت ها'])
                    ...
                    <form action="{{ route('admin.ticket.priority.update', $ticketPriority->id) }}" method="POST">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">ویرایش اولویت تیکت</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>عنوان</label>
                                            <input type="text" class="form-control" name="name" value="{{ old('name', $ticketPriority->name) }}">
                                            @error('name')
