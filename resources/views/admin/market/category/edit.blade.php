...
@section('title', 'ادمین - ویرایش دسته بندی محصولات')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" id="tags" name="tags" value="{{ old('tags', $productCategory->tags) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="parent_id">
                                                ...
                                                @foreach($allCategoreis as $category)
                                                    <option value="{{ $category->id }}" @if(old('parent_id', $productCategory->parent_id) == $category->parent_id) checked @endif>{{ $category->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach ($productCategory->image['index_array'] as $key => $value)
                                                <div class="col-{{ 6 / $number }}">
                                                    <input type="radio" name="current_image" id="size-{{ $key }}" value="{{ $key }}" @if($productCategory->image['current_image'] == $key) checked @endif>
                                                    <label for="size-{{ $key }}">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label>توضیحات</label>
                                            <textarea class="form-control" name="description" rows="5">{{ old('description', $productCategory->description) }}</textarea>
                                            @error('description')
                                            <div class="text-danger pt-2">
                                                {{$message}}
                                            </div>
