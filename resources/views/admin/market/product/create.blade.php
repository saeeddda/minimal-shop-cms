...
@section('title', 'ادمین - افزودن محصول')

@section('content')
    @include('admin.layouts.breadcrumb',['title'=>'افزودن محصول'])
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="introduction" class="form-control" id="introduction" rows="10">{{ old('introduction') }}</textarea>
                                            @error('introduction')
                                            <div class="text-danger pt-2">
                                                {{$message}}
                                            </div>
