...
@section('title', 'ادمین - افزودن مشتری')

@section('content')
    @include('admin.layouts.breadcrumb',['title'=>'افزودن مشتری'])
                    ...
                    <form action="{{ route('admin.user.customer.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">مشتری جدید</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                            ...
                            <div class="card-footer">
                                <a href="{{ route('admin.user.customer.index') }}" class="btn btn-default"><i class="fa fa-chevron-left mr-1"></i>بازگشت</a>
