...
@section('title', 'ادمین - نظر محتوا')

@section('content')
    @include('admin.layouts.breadcrumb', ['title' => 'نظر محتوا'])
                    ...
                    <form action="{{ route('admin.content.comment.answer', $comment->id) }}" method="POST">
                        ...
                        <div class="card">
                                ...
                                <div class="card card-info">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <h5 class="mb-2">نظر برای : {{ $comment->commentable->title }} - {{ $comment->commentable->id }}</h5>
                                            <p>{{ $comment->body }}</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer">
                                <a href="{{ route('admin.content.comment.index') }}" class="btn btn-default"><i class="fa fa-chevron-left mr-1"></i>بازگشت</a>
