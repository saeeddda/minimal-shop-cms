...
@section('title', 'ادمین - افزودن صفحه')

@section('content')
    @include('admin.layouts.breadcrumb',['title'=>'افزودن صفحه'])
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.content.page-builder.store') }}" method="POST" id="form">
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label>محتوا</label>
                                            <textarea name="body" id="body" rows="15" class="form-control">{{ old('body') }}</textarea>
                                            @error('body')
                                                <div class="text-danger pt-2">
                                                    {{$message}}
                                                </div>
                            ...
                            <div class="card-footer">
                                <a href="{{ route('admin.content.page-builder.index') }}" class="btn btn-default"><i class="fa fa-chevron-left mr-1"></i>بازگشت</a>
