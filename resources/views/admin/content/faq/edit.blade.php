...
@section('title', 'ادمین - ویرایش سوال متداول')

@section('content')
    @include('admin.layouts.breadcrumb',['title'=>'ویرایش سوال متداول'])
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" id="tags" name="tags" value="{{ old('tags', $faq->tags) }}">
                                    ...
                                    <div class="col-12">    
                                        <div class="form-group">
                                            <label>پاسخ</label>
                                            <textarea name="answer" id="answer" rows="15" class="form-control">{{ old('answer', $faq->answer) }}</textarea>
                                            @error('answer')
                                                <div class="text-danger pt-2">
                                                    {{$message}}
                                                </div>
