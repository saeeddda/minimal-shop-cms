...
@section('title', 'ادمین - ویرایش اعلان پیامکی')

@section('content')
    @include('admin.layouts.breadcrumb',['title'=>'ویرایش اعلان پیامکی'])
                    ...
                    <form action="{{ route('admin.notify.sms.update', $sms->id) }}" method="POST">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">ویرایش اعلان پیامکی</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" value="{{ old('title', $sms->title) }}">
                                            @error('title')
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="published_view" class="form-control" value="{{ $sms->published_at }}">
                                            <input type="hidden" id="published_at" name="published_at" class="form-control" value="{{ $sms->published_at }}">
                                            @error('published_at')
                                            <div class="text-danger pt-2">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="body" rows="5" class="form-control">{{ old('body', $sms->body) }}</textarea>
                                            @error('body')
                                            <div class="text-danger pt-2">
                                                {{$message}}
                                            </div>
