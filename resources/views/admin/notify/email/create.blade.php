...
@section('title', 'ادمین - افزودن اعلان ایمیلی')

@section('content')
    @include('admin.layouts.breadcrumb',['title'=>'افزودن اعلان ایمیلی'])
                    ...
                    <form action="{{ route('admin.notify.email.store') }}" method="POST">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">اعلان ایمیلی جدید</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="body" id="email_content" rows="15" class="form-control">{{ old('body') }}</textarea>
                                            @error('body')
                                                <div class="text-danger pt-2">
                                                    {{$message}}
                                                </div>
