...
class UserRoleController extends Controller
{
    ...
    public function store(RoleRequest $request)
    {
        ...
        return redirect()->route('admin.user.role.index')
            ->with('alert-success', 'نقش افزوده شد.');
    }
    ...
    public function update(RoleRequest $request, Role $role)
    {
        ...
        return redirect()->route('admin.user.role.index')
            ->with('alert-success', 'نقش ویرایش شد.');
    }
    ...
    public function destroy(Role $role)
    {
        $role->delete();
        return redirect()->route('admin.user.role.index')
            ->with('alert-success', 'نقش حذف شد.');
    }

    public function permissionEdit(Role $role)
    {
        $permissions = Permission::all();
        return view('admin.user.role.permission-edit', compact('role', 'permissions'));
    }
    ...
    public function permissionUpdate(RoleRequest $request, Role $role)
    {
        ...
        return redirect()->route('admin.user.role.index')
            ->with('alert-success', 'دسترسی نقش ویرایش شد.');
    }
}
