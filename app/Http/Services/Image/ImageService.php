...
class ImageService extends ImageToolService
{
    ...
    public function createIndexAndSave($image){
        ...
        $iamgeName = $this->getImageName();

        $indexArray = [];

        foreach($imageSizes as $sizeAlias => $imageSize){
            $currentImageName = $iamgeName . '_' . $sizeAlias;
        ...
        $images['index_array'] = $indexArray;
        $images['directory'] = $this->getFinalImageDirectory();
        $images['current_image'] = Config::get('image.default-current-index-image');
