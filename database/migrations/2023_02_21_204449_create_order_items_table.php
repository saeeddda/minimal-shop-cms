...
class CreateOrderItemsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_items', function (Blueprint $table) {
            ...
            $table->foreignId('amazing_coupon_id')->nullable()->constrained('amazing_coupons')->onUpdate('cascade')->onDelete('cascade');
            $table->longText('amazing_coupon_object')->nullable();
            $table->decimal('amazing_coupon_amount',20,3)->nullable();
